...
const SectionCandidateShortIntro = ({ candidate }) => {
  ...
  const notSpecified = language === "ar" ? "غير محدد" : language === "am" ? "አልተገለጸም" : "Not specified";
  const hour = language === "ar" ? "ساعة" : language === "am" ? "ሰዓት" : "hour";
      ...
      <div className="can-intro-header" style={{ backgroundImage: `url('${publicUrlFor("images/candidates/candidate-bg.webp")}')` }}>
        ...
        <div className="can-intro-content">
          ...
          <div className="can-intro-info">
            ...
            <p className="can-intro-title">{candidate.profession || candidate.job_title || notSpecified}</p>
