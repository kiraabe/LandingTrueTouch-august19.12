...
<CountUp end={10} duration={10} />
      ...
      <div dir={isArabic ? "rtl" : "ltr"} className={`section-full p-t120 p-t180 pos-relative site-bg-white twm-featured-city-area featured-section-spaced ${isArabic ? "industries-section-rtl" : ""}`}>
